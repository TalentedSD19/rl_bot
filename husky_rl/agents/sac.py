...
from husky_rl.config import SAC, MAX_STEPS, N_ACTIONS, PHASE_NAMES, ACTION_NAMES
from husky_rl.environment import HuskyTask2Env
from husky_rl.models import SACDiscreteActor, SACDiscreteCritic
...
def train(save_prefix: str = "checkpoints/husky_sac"):
...
def run_trained(model_path: str = "checkpoints/husky_sac_best.pth", n_episodes: int = 5):
