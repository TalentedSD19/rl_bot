...
from husky_rl.config import PPO, MAX_STEPS, PHASE_NAMES, ACTION_NAMES
from husky_rl.environment import HuskyTask2Env
from husky_rl.models import ActorCritic, apply_spin_mask
...
def train(save_prefix: str = "checkpoints/husky_ppo"):
...
def run_trained(model_path: str = "checkpoints/husky_ppo_best.pth", n_episodes: int = 5):
