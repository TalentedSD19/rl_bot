...
RED_CLOSE_AREA     = 0.150  # red   area fraction that triggers DROP
...
class HuskyTask2Env:
    ...
    def _reward(self, obs, action):
        ...
        # Directional steering bonus — proportional to error to reduce overshoot oscillation
        ...
        # Phase-specific: APPROACH → reward area growth, trigger automation
            ...
            # Extra centring incentive when close to target, reward being near dead centre
            ...
            # Tighter centring required for both PICKUP and DROP
...
if __name__ == "__main__":
    if len(sys.argv) > 1 and sys.argv[1] == "run":
        path = sys.argv[2] if len(sys.argv) > 2 else "husky_task2_ppo_best.pth"
